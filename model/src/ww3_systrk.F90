...
900 FORMAT (/15X,'    *** WAVEWATCH III Wave system tracking ***  '/ &
  ...
  CALL MPI_BCAST(filename,80,MPI_CHARACTER,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(tstart,1,MPI_DOUBLE_PRECISION,0, &
       MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(tend,1,MPI_DOUBLE_PRECISION,0, &
       MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(dt,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(ntint,1,MPI_INTEGER,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(minlon,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(maxlon,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(minlat,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(maxlat,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(mxcwt,1,MPI_INTEGER,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(mycwt,1,MPI_INTEGER,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(dirKnob,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(perKnob,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(hsKnob,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(wetPts,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(dirTimeKnob,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(tpTimeKnob,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(seedLon,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(seedLat,1,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(noutp,1,MPI_INTEGER,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(lonout,100,MPI_REAL,0,MPI_COMM_WW3,IERR)
  CALL MPI_BCAST(latout,100,MPI_REAL,0,MPI_COMM_WW3,IERR)
#endif
